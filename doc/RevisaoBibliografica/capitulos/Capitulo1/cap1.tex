...
\chapter{Introdução}
    O tamanho de dados utilizados cresce cada vez mais, a extração de informação em boa performance e a apresentação das mesmas são desafios cada vez maiores, são tantos detalhes e perspectivas para alcançar o objetivo de se utilizar os dados que para cumprir esta tarefa é necessário o conhecimento de diversas áreas, dentre elas Visualização de Dados, Mineração de Dados e Bases de Dados Não Convencionais, áreas que seram melhor esclarecidas nos capítulos que seguem.
...
\section{Objetivos do Trabalho}
    ...
    PostgreSQL e os tipos de dados não convencionais: aspectos sobre o próprio PostgreSQL e os novos tipos de dados orientados a documento que vem fornecendo
