...
\item Agrupamento (Clustering) de Dados: Os dados são agrupados sem uma pré-separação por classes 
\end{itemize}


Além da necessidade de extrair informações relevantes de bases de dados é importante que exista um meio para apresent
...
\section{Técnicas de Visualização}
	...
	\subsection{Técnicas de Visualização de Múltiplas Coordenadas}
	\subsubsection{Variação Temporal Uni-escala}
	\subsubsection{Variação Temporal Multi-escala}
opa
\cite{heer}
Opa
\cite{genghini}
